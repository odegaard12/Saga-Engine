const CACHE_NAME = 'saga-player-shell-v3.1.2-rev1'
const TILE_CACHE_NAME = 'saga-route-tile-coverage-v3.1.2-rev1'
const FIELD_PROOF_ASSET_CACHE = 'saga-field-proof-assets-v3.1.2-rev1'
