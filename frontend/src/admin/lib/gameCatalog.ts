...
export const adminGameCatalog: AdminGameCatalogItem[] = [
  {
    ...
    playerGoal: 'Encontrar la zona de máxima señal y mantener posición unos segundos.',
    editorHint: 'Úsalo como checkpoint GPS jugable. Ponlo siempre en zonas seguras y accesibles.',
    config: {
      ...
      noise_floor: 0,
      jitter: 2,
      easy_checkpoint: false,
      game_id: 'gps_signal_lock',
    },
    content: 'Acércate al área marcada, busca el pico de señal y mantente quieto en la zona de captura.',
    messages: {
      hint: 'Busca el punto de máxima señal, no basta con entrar en el radio.',
