...
export const missionTemplates: MissionTemplate[] = [
  {
    ...
    stages: [
      { gameId: 'bearing_compass', title: 'Inicio de ruta', content: 'Llega al punto inicial y activa la misión.', offsetLat: 0, offsetLon: 0, radius: 55 },
      ...
      { gameId: 'bearing_compass', title: 'Puerta bloqueada', content: 'Este nodo pide la llave anterior.', offsetLat: 0.00088, offsetLon: 0.00062, radius: 55, requiresPreviousItem: true },
  ...
  },
  {
    ...
    stages: [
      { gameId: 'bearing_compass', title: 'Punto de inicio', content: 'Llega al punto de salida y abre la primera pista.', offsetLat: 0, offsetLon: 0, radius: 55 },
      ...
      { gameId: 'bearing_compass', title: 'Busca la señal', content: 'La señal se hace más fuerte al acercarte.', offsetLat: 0.00080, offsetLon: -0.00058, radius: 55 },
  ...
  },
  {
    ...
    stages: [
      { gameId: 'bearing_compass', title: 'Entrada', content: 'Activa el punto de entrada del escape.', offsetLat: 0, offsetLon: 0, radius: 50 },
      ...
      { gameId: 'bearing_compass', title: 'Salida bloqueada', content: 'Usa la llave anterior y llega al punto de salida.', offsetLat: -0.00075, offsetLon: 0.00068, radius: 55, requiresPreviousItem: true },
  ...
  },
  {
    ...
    stages: [
      { gameId: 'bearing_compass', title: 'Punto de salida', content: 'Empieza la gymkhana.', offsetLat: 0, offsetLon: 0, radius: 60 },
