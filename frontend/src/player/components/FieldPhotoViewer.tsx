...
const overlay: CSSProperties = {
  ...
  alignItems: 'center',
  padding: '16px 12px',
  background: 'rgba(var(--theme-ink-deep), .75)',
...
const sheet: CSSProperties = {
  ...
  background: 'linear-gradient(180deg, rgb(var(--theme-ink)) 0%, rgb(var(--theme-ink-deep)) 100%)',
  color: '#f8fafc',
  display: 'grid',
  gap: 12,
  border: '1px solid rgba(var(--theme-info), 0.25)',
  boxShadow: '0 25px 60px rgba(0, 0, 0, 0.7), 0 0 30px rgba(var(--theme-info-mid), 0.15)',
}
...
const downloadButton: CSSProperties = {
  ...
  height: 38,
  borderRadius: 'var(--theme-radius-pill)',
  border: '1px solid rgba(var(--theme-done-soft), .30)',
  background: 'rgba(var(--theme-done), .16)',
