 ...
 * Tambien en diagonal.
 *
 * El patron se hacia solo con arriba, abajo, izquierda y derecha, asi que
 * siempre salia una serpiente continua de tramos rectos y giros de noventa
 * grados. Eso no se memoriza como trece celdas: se memoriza como UNA forma, de
 * una pasada, y por eso el reto se pasaba sin esfuerzo.
 *
 * Con las ocho direcciones el camino deja de leerse como un trazo ordenado y
 * hay que retener el recorrido de verdad. Sigue siendo un camino conectado
 * -que es lo que pide el juego, restaurar un circuito-, pero ya no es una
 * figura obvia.
 */
