...
const ES: Record<string, string> = {
  ...
  'Objective': 'Objetivo',
  'Hint': 'Pista',
  'Live local preview · use Save in Mission Control to persist': 'Vista local en vivo · usa Guardar en Control de misión para persistir',

  'Players & teams': 'Jugadores y equipos',
  'Manage who can play this mission. Save players to persist changes.': 'Gestiona quién puede jugar esta misión. Guarda jugadores para persistir los cambios.',
