...
const GL: Record<string, string> = {
  ...
  // Minijuegos: cadenas vistas en castellano durante la partida de prueba
  // (laberinto, mosaico, circuitos, Caza-Señales y respaldo de QR).
  'Recoge los objetos ◆, evita los agujeros × y llega a la bandera ⚑.':
    'Recolle os obxectos ◆, evita os buratos × e chega á bandeira ⚑.',
  'Inclina suavemente el móvil o usa los botones.':
    'Inclina suavemente o móbil ou usa os botóns.',
  'Mantén el móvil cómodo para calibrar': 'Mantén o móbil cómodo para calibrar',
  'Sensor no disponible · usa botones': 'Sensor non dispoñible · usa botóns',
  'Modo táctil activo': 'Modo táctil activo',
  'Botones táctiles disponibles': 'Botóns táctiles dispoñibles',
  'Recalibrar': 'Recalibrar',
  'Volver al inicio': 'Volver ao inicio',
  'Iniciar laberinto': 'Iniciar labirinto',
  'Pared. Busca otra dirección.': 'Parede. Busca outra dirección.',
  'Objeto recogido.': 'Obxecto recollido.',
  'Se terminó el tiempo.': 'Rematou o tempo.',
  'Has perdido todas las vidas.': 'Perdiches todas as vidas.',
  'La salida está cerrada. Recoge todos los objetos.':
    'A saída está pechada. Recolle todos os obxectos.',
  'Todos los objetos recogidos. Busca la salida.':
    'Todos os obxectos recollidos. Busca a saída.',
  'segundos': 'segundos',
  'vidas': 'vidas',
  'objetos': 'obxectos',
  'Has recogido todos los objetos y alcanzado la salida.':
    'Recolliches todos os obxectos e chegaches á saída.',

  // Mosaico
  'Mezclar de nuevo': 'Mesturar de novo',
  'Ver referencia': 'Ver referencia',
  'MOVIMIENTOS': 'MOVEMENTOS',
  'MEMORIZA': 'MEMORIZA',
  'Piezas bien colocadas': 'Pezas ben colocadas',
  'Toca una pieza para seleccionarla.': 'Toca unha peza para seleccionala.',
  'Observa con calma las formas, los colores y los detalles principales.':
    'Observa con calma as formas, as cores e os detalles principais.',
  'Empezar ahora': 'Comezar agora',

  // Circuitos
  'Preparado': 'Preparado',
  'Pulsa iniciar cuando estés listo. Tienes 3 intentos.':
    'Pulsa iniciar cando esteas listo. Tes 3 intentos.',
  'Iniciar': 'Iniciar',

  // Caza-Señales
  'Toca sólo las chispas verdes. Las rojas te quitan tiempo.':
    'Toca só as chispas verdes. As vermellas quítanche tempo.',

  // Respaldo de QR y ficha del nodo
  '¿Atascado? Escribe el código de respaldo · +2 min':
    '¿Atascado? Escribe o código de respaldo · +2 min',
  'Ocultar código de respaldo': 'Agochar o código de respaldo',
  'Analizando la foto... un momento.': 'Analizando a foto... un momento.',
  'Hacer foto y validar': 'Facer foto e validar',
  'Suma 2 minutos a tu tiempo.': 'Suma 2 minutos ao teu tempo.',
  'Activando la cámara...': 'Activando a cámara...',
  'Guardando...': 'Gardando...',
  'RECOGER OBJETO': 'RECOLLER OBXECTO',
