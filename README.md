...
[![Version](https://img.shields.io/badge/version-2.1.0-34d399?style=flat-square)](CHANGELOG.md)
...
Sistema extensible de familias de minijuegos. En v2.1.0 incluye:
...
| `SAGA_VERSION` | Versión mostrada en el cliente | `2.1.0` |
