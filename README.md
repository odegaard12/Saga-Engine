...
- `frontend/src/admin/AdminApp.tsx` -> React admin minimal protected login, legacy-style operator shell, local CMS actions, persistent node save flow, map-first workspace and editable-preview node drawer
