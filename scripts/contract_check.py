...
def check_minigame_normalization() -> None:
    ...
    assert_equal(circuit["objective"], "path_restore", "circuit objective")
    assert_equal(circuit["grid_cols"], 5, "circuit cols")
    assert_equal(circuit["grid_rows"], 5, "circuit rows")
