...
player=(R/'frontend/src/player/PlayerApp.tsx').read_text()
map_surface=(R/'frontend/src/player/components/MapSurface.tsx').read_text()
hud=(R/'frontend/src/player/components/PlayerHud.tsx').read_text()
offline=(R/'frontend/src/player/components/MissionPackPanel.tsx').read_text()
pwa=(R/'frontend/src/player/offline/pwaShell.ts').read_text(); sw=(R/'frontend/public/sw.js').read_text()
