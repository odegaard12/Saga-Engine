...
El contenedor activo de producción debe montar solo los datos runtime:
    ...
    /home/odegaard12/saga_engine_data -> /app_data

## Estado esperado de producción

Estado esperado:

    Repositorio de trabajo: /home/odegaard12/saga_engine_phase1
    Datos runtime:          /home/odegaard12/saga_engine_data
    Puerto del contenedor:  8096 -> 5000
    Dominio público:        sagaengine.odegaard12.es
    Origen del túnel:       http://192.168.68.103:8096
...
Salida esperada de mounts:
    ...
    bind /home/odegaard12/saga_engine_data -> /app_data
...
Ejemplo de contenedor de producción:
    ...
    docker run -d \
      ...
      -v /home/odegaard12/saga_engine_data:/app_data \
      -p 0.0.0.0:8096:5000 \
      saga_engine:latest \
